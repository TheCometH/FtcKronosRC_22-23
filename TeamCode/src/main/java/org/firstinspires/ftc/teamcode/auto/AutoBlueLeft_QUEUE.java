...
// THIS IS JUST TO SEE IF THE TRAJECTORIES WORK, BEFORE MAYBE IT THREW A CONTIUITY ERROR IDK
...
@Autonomous
public class AutoBlueLeft_QUEUE extends LinearOpMode {
    @Override
    public void runOpMode() {
        ...
        drive.setPoseEstimate(startPose);a
